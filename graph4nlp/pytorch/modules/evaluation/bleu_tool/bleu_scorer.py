...
"""Provides:
cook_refs(refs, n=4): Transform a list of reference sentences as strings into a form usable \
    by cook_test().
cook_test(test, refs, n=4): Transform a test sentence as a string (together with the cooked \
    reference sentences) into a form usable by score_cooked().
"""
import copy
import math
...
class BleuScorer(object):
    ...
    def score_ratio(self, option=None):
        """return (bleu_tool, len_ratio) pair"""
    ...
    def compute_score(self, option=None, verbose=0):
        ...
        for comps in self.ctest:
            ...
            # append per image bleu_tool score
            bleu = 1.0
            for k in range(n):
