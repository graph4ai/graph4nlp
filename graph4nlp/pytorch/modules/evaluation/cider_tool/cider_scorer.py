...
class CiderScorer(object):
    ...
    def compute_cider(self, df_mode="corpus"):
        def counts2vec(cnts):
            ...
            The function returns vec, an array of dictionary that store mapping of n-gram \
                and tf-idf weights.
