...
class DecoderBase(nn.Module):
    ...
    def __init__(self, attentional=True, use_copy=False, use_coverage=False,
...
class RNNDecoderBase(DecoderBase):
    def __init__(self, attentional=True, use_copy=False, use_coverage=False, attention_type="uniform",
                 fuse_strategy="average", teacher_forcing_ratio=1.):
        super(RNNDecoderBase, self).__init__(attentional=attentional, use_copy=use_copy, use_coverage=use_coverage,
