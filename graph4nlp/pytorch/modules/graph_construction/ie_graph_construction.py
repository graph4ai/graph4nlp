...
class IEBasedGraphConstruction(StaticGraphConstructionBase):
    ...
    def forward(self, batch_graphdata: list):
        """
            Compute the node/edge features for a batch of GraphData objects.

        Parameters
        ----------
        batch_graphdata: list[GraphData]

        Returns
        -------
        batch_gd: GraphData
            The large graph containing all the graphs in the batch with node/edge features.
