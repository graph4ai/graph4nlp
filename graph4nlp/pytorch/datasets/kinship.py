...
class KinshipDataset(KGCompletionDataset):
    def __init__(self,
                 ...
                 word_emb_size=300,
                 **kwargs):
        super(KinshipDataset, self).__init__(root_dir,
    ...
    def raw_file_names(self):
        ...
        """
        return {"train": "e1rel_to_e2_train.json",
...
if __name__ == '__main__':
    dataset = KinshipDataset(root_dir='examples/pytorch/kg_completion/data/kinship',
                             topology_subdir='kgc')