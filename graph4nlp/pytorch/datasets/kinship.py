...
class KinshipDataset(KGCompletionDataset):
    ...
    def raw_file_names(self) -> dict:
        ...
        return {'train': 'e1rel_to_e2_ranking_train.json', 'test': 'e1rel_to_e2_ranking_test.json'}

    @property
    def processed_file_names(self) -> dict:
        return {'vocab': 'vocab.pt', 'data': 'data.pt', 'KG_graph': 'KG_graph.pt', 'split_ids':'split_ids.pt'}
