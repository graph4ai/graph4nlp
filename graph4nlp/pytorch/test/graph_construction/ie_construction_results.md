...
School, a private school in Seattle, where he befriended Bill Gates, 
two years younger, with whom he shared an enthusiasm for computers. 
Paul and Bill used a teletype terminal at their high school, Lakeside, 
to develop their programming skills on several time-sharing computer 
systems.
```
...
{'edge_tokens': ['COM'], 'src': {'tokens': ['Paul', 'Allen'], 'id': 0}, 'tgt': {'tokens': ['Kenneth', 'Sam', 'Allen'], 'id': 1}}
{'edge_tokens': ['COM'], 'src': {'tokens': ['Paul', 'Allen'], 'id': 0}, 'tgt': {'tokens': ['teletype', 'terminal', 'at', 'Paul'], 'id': 12}}
{'edge_tokens': ['COM'], 'src': {'tokens': ['Seattle', 'Washington'], 'id': 3}, 'tgt': {'tokens': ['Seattle'], 'id': 5}}
{'edge_tokens': ['COM'], 'src': {'tokens': ['Seattle', 'Washington'], 'id': 3}, 'tgt': {'tokens': ['private', 'school', 'in', 'Seattle'], 'id': 7}}
{'edge_tokens': ['COM'], 'src': {'tokens': ['Seattle'], 'id': 5}, 'tgt': {'tokens': ['private', 'school', 'in', 'Seattle'], 'id': 7}}
{'edge_tokens': ['COM'], 'src': {'tokens': ['Bill', 'Gates'], 'id': 6}, 'tgt': {'tokens': ['Bill'], 'id': 10}}
{'edge_tokens': ['COM'], 'src': {'tokens': ['private', 'school', 'in', 'Seattle'], 'id': 7}, 'tgt': {'tokens': ['private', 'school'], 'id': 9}}
is_connected=True
...
{'Edges': [(0, 1), (0, 2), (0, 3), (4, 5), (0, 6), (0, 7), (0, 8), (9, 5), (10, 11), (10, 12), (0, 13), (4, 13), (9, 13), (10, 13), (0, 1), (0, 12), (3, 5), (3, 7), (5, 7), (6, 10), (7, 9)]}
