...
parser.add_argument('--prediction_type', type=str, default='ele_sum', help="'ele_sum','concat_NN','stacked_ele_prod")
...
def gae_for(args):
    ...
    for epoch in range(args.epochs):
        ...
        loss = loss_function(preds=sample.view(-1), labels=adj_label.view(-1),
