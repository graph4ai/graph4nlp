...
class Graph2Tree(nn.Module):
    def __init__(self, src_vocab,
        ...
        gnn_type : [type]
            [description]
        direction_option : [type]
            [description]
        graph_construction_type : [type]
            [description]
        enc_hidden_size : [type]
            [description]
        dec_hidden_size : [type]
            [description]
        dropout_for_word_embedding : [type]
            [description]
        dropout_for_encoder_feature : [type]
            [description]
        dropout_for_encoder_attn : [type]
            [description]
        dropout_for_decoder : [type]
            [description]
        device : [type]
            [description]
        criterion : [type]
            [description]
        teacher_force_ratio : [type]
            [description]
        max_dec_seq_length : [type]
            [description]
        max_dec_tree_depth : [type]
            [description]
        embedding_style : [type]
            [description]
        K : [type]
            [description]
        gat_head : [type]
