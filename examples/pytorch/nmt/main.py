        ...
        for epoch in range(200):
            ...
            if epoch >= 0:
                ...
                if score >= max_score:
                    ...
                    self.model.save_checkpoint(os.path.join("examples/pytorch/nmt/save", opt["name"]), "best.pth")
...
if __name__ == "__main__":
    ...
    runner.model = Graph2Seq.load_checkpoint(os.path.join("examples/pytorch/nmt/save", opt["name"]), "best.pth").to(runner.device)
    runner.translate()
