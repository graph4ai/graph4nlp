...
def get_args():
    ...
    parser.add_argument(
        "--dataset_yaml",
        type=str,
        default="examples/pytorch/semantic_parsing/graph2tree/jobs/config/new_dynamic_graphsage_undirected.yaml",  # noqa
    )

    parser.add_argument("--learning-rate", type=float, default=1e-3)
    parser.add_argument("--gpuid", type=int, default=1, help="which gpu to use. -1 = use CPU")
    parser.add_argument(
        "--seed", type=int, default=1237, help="torch manual random number generator seed"
    )
    ...
    parser.add_argument("--pretrained_word_emb_name", type=str, default=None, help="")
    ...
    parser.add_argument(
        ...
        type=str,
        default="examples/pytorch/semantic_parsing/graph2tree/jobs/save",
    )
