...
class Graph2Tree(nn.Module):
    def __init__(self, src_vocab,
        ...
        if gnn_type == "GAT":
            self.encoder = GAT(3, enc_hidden_size, enc_hidden_size, enc_hidden_size, [2, 2, 1], direction_option=direction_option, feat_drop=enc_dropout_for_feature, attn_drop=enc_dropout_for_attn, activation=F.relu, residual=False)
        elif gnn_type == "GGNN":
