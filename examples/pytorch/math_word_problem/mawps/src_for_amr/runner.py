...
from utils import AMRDataItem, EdgeText2TreeDataset, RGCNGraph2Tree, AMRGraph2Tree
...
class Mawps:
    ...
    def eval(self, model, mode="val"):
        from examples.pytorch.math_word_problem.mawps.src.evaluation import compute_tree_accuracy
