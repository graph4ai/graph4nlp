...
def get_args():
    ...
    main_arg_parser.add_argument('-data_dir', type=str, default='/home/lishucheng/Graph4AI/graph4nlp/examples/pytorch/semantic_parsing/graph2tree/mathqa/mathqa_data/', help='data path')
    ...
    main_arg_parser.add_argument('-max_dec_tree_depth', type=int, default=5)
