...
if __name__ == "__main__":
    ...
    main_arg_parser.add_argument('-data_dir', type=str, 
            default='/home/lishucheng/Graph4AI/graph4nlp/examples/pytorch/math_word_problem/data/mathqa', help='data path')
    main_arg_parser.add_argument('-checkpoint_dir',type=str, 
            default= '/home/lishucheng/Graph4AI/graph4nlp/examples/pytorch/math_word_problem/checkpoint_dir_mathqa', help='output directory where checkpoints get written')
    ...
    main_arg_parser.add_argument(
        '-max_dec_tree_depth_for_test', type=int, default=40)
