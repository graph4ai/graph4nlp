...
# screen -S ghn_code2 python -m examples.pytorch.summarization.cnn.main --word-emb-size 300 --topology_subdir DependencyGraph_seq2seq --hidden-size 256 --batch_size 40 --log-file examples/pytorch/summarization/cnn/log/log_s2s.txt --checkpoint-save-path /raid/ghn/graph4nlp/examples/pytorch/summarization/cnn/save_dep_s2s --lr-decay-rate 0.8 --learning-rate 0.01 --gpu 2
...
# screen -S ghn_code2 python -m examples.pytorch.summarization.cnn.main --word-emb-size 128 --topology_subdir Seq2seq_30k --hidden-size 512 --batch_size 50 --log-file examples/pytorch/summarization/cnn/log/log_s2s_30k_copy1.txt --checkpoint-save-path /raid/ghn/graph4nlp/examples/pytorch/summarization/cnn/save_s2s_30k_copy --lr-decay-rate 0.8 --learning-rate 1e-3
# screen -S ghn_code1 python -m examples.pytorch.summarization.cnn.main --word-emb-size 128 --topology_subdir Seq2seq_30k --hidden-size 512 --batch_size 40 --log-file examples/pytorch/summarization/cnn/log/log_s2s_30k_copy2.txt --checkpoint-save-path /raid/ghn/graph4nlp/examples/pytorch/summarization/cnn/save_s2s_30k_copy --lr-decay-rate 0.8 --learning-rate 0.001 --use_copy True --use_coverage True
# screen -S ghn_code1 python -m examples.pytorch.summarization.cnn.main --word-emb-size 128 --topology_subdir Seq2seq_30k_t --hidden-size 512 --batch_size 40 --log-file examples/pytorch/summarization/cnn/log/log_s2s_30k_copy3.txt --checkpoint-save-path /raid/ghn/graph4nlp/examples/pytorch/summarization/cnn/save_s2s_30k_copy3 --lr-decay-rate 0.8 --learning-rate 0.001 --use_copy True --use_coverage True
