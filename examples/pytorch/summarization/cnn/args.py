...
# screen -S ghn_code1 -L -Logfile examples/pytorch/summarization/cnn/log/screen_ie_1w.log python -m examples.pytorch.summarization.cnn.main_g2s --dataset_yaml examples/pytorch/summarization/cnn/config/new_ie_graphsage.yaml --word-emb-size 128 --log-file examples/pytorch/summarization/cnn/log/log_gs_ie.log --checkpoint-save-path examples/pytorch/summarization/cnn/save_g2s_1w_copy_ie --learning-rate 0.001 --lr-decay-rate 0.8 --batch_size 30
# screen -S ghn_code_eval -L -Logfile examples/pytorch/summarization/cnn/log/screen_ie_1w_eval.log python -m examples.pytorch.summarization.cnn.main_g2s --dataset_yaml examples/pytorch/summarization/cnn/config/new_ie_graphsage.yaml --word-emb-size 128 --log-file examples/pytorch/summarization/cnn/log/log_gs_ie_eval.log --checkpoint-save-path examples/pytorch/summarization/cnn/save_g2s_1w_copy_ie --learning-rate 0.001 --lr-decay-rate 0.8 --batch_size 30
# screen -S ghn_code_eval -L -Logfile examples/pytorch/summarization/cnn/log/screen_eval_bs2.log python -m examples.pytorch.summarization.cnn.main_g2s --dataset_yaml examples/pytorch/summarization/cnn/config/new_dependency_graphsage.yaml --word-emb-size 128 --log-file examples/pytorch/summarization/cnn/log/log_gs_dep_bs2.log --checkpoint-save-path examples/pytorch/summarization/cnn/save_g2s_3w_copy_dep --learning-rate 0.001 --lr-decay-rate 0.8 --batch_size 20 --beam-size 2
# screen -S ghn_code_eval -L -Logfile examples/pytorch/summarization/cnn/log/screen_eval_bs10.log python -m examples.pytorch.summarization.cnn.main_g2s --dataset_yaml examples/pytorch/summarization/cnn/config/new_dependency_graphsage.yaml --word-emb-size 128 --log-file examples/pytorch/summarization/cnn/log/log_gs_dep_bs10.log --checkpoint-save-path examples/pytorch/summarization/cnn/save_g2s_3w_copy_dep --learning-rate 0.001 --lr-decay-rate 0.8 --batch_size 20 --beam-size 10
# screen -S ghn_code_eval -L -Logfile examples/pytorch/summarization/cnn/log/screen_eval_bs5.log python -m examples.pytorch.summarization.cnn.main_g2s --dataset_yaml examples/pytorch/summarization/cnn/config/new_dependency_graphsage.yaml --word-emb-size 128 --log-file examples/pytorch/summarization/cnn/log/log_gs_dep_bs5.log --checkpoint-save-path examples/pytorch/summarization/cnn/save_g2s_3w_copy_dep --learning-rate 0.001 --lr-decay-rate 0.8 --batch_size 20 --beam-size 5
# screen -S ghn_code_eval -L -Logfile examples/pytorch/summarization/cnn/log/screen_eval_bs1.log python -m examples.pytorch.summarization.cnn.main_g2s --dataset_yaml examples/pytorch/summarization/cnn/config/new_dependency_graphsage.yaml --word-emb-size 128 --log-file examples/pytorch/summarization/cnn/log/log_gs_dep_bs1.log --checkpoint-save-path examples/pytorch/summarization/cnn/save_g2s_3w_copy_dep --learning-rate 0.001 --lr-decay-rate 0.8 --batch_size 20 --beam-size 1
# screen -S ghn_code_eval -L -Logfile examples/pytorch/summarization/cnn/log/screen_eval_greedysearch.log python -m examples.pytorch.summarization.cnn.main_g2s --dataset_yaml examples/pytorch/summarization/cnn/config/new_dependency_graphsage.yaml --word-emb-size 128 --log-file examples/pytorch/summarization/cnn/log/log_gs_dep_greedysearch.log --checkpoint-save-path examples/pytorch/summarization/cnn/save_g2s_3w_copy_dep --learning-rate 0.001 --lr-decay-rate 0.8 --batch_size 20
# screen -S ghn_code2 -L -Logfile examples/pytorch/summarization/cnn/log/screen_dep.log python -m examples.pytorch.summarization.cnn.main_g2s --dataset_yaml examples/pytorch/summarization/cnn/config/new_dependency_graphsage.yaml --word-emb-size 128 --log-file examples/pytorch/summarization/cnn/log/log_gs_dep.log --checkpoint-save-path examples/pytorch/summarization/cnn/save_g2s_3w_copy_dep --learning-rate 0.001 --lr-decay-rate 0.8 --batch_size 30
