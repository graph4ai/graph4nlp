...
class ModelHandler:
    def __init__(self, config):
        ...
        self.model = TextClassifier.load_checkpoint(os.path.join(self.config['out_dir'], self.config.get('model_ckpt_name', Constants._SAVED_WEIGHTS_FILE))).to(self.config['device'])
    ...
    def evaluate(self, dataloader):
        ...
        with torch.no_grad():
            ...
            pred_path = os.path.join(self.config['out_dir'], self.config.get('out_pred', 'pred.json'))
